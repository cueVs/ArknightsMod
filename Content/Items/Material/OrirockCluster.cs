...
{
	public class OrirockCluster : ModItem
	{
		public override void SetStaticDefaults() {
            // DisplayName.SetDefault("Orirock Cluster"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
            // Tooltip.SetDefault("A conglomerate rock mined from the ground."); // The (English) text shown below your item's name
